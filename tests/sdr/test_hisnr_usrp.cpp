#include "../../sdr/hisnr_usrp.hpp"
#include "../../sdr/usrp_rf_settings.hpp"
...
class SdrHwTest{
    public:
    void revealCheck10MhzLock(HiSnrUsrp& sdr){sdr.check10MhzLock();}
    void revealGpsLock(HiSnrUsrp& sdr){sdr.gpsLock();}
    void revealCheckAndSetTime(HiSnrUsrp& sdr){sdr.checkAndSetTime();}
    void revealDetectChannels(HiSnrUsrp& sdr){sdr.detectChannels();}
    void revealSetRFParams(HiSnrUsrp& sdr){sdr.setRFParams();}
    void revealRefLoLockDetect(HiSnrUsrp& sdr){sdr.refLoLockDetect();}
    void revealSetupGpio(HiSnrUsrp& sdr){sdr.setupGpio();}
    void revealSetupTx(HiSnrUsrp& sdr){sdr.setupTx();}
    void revealSetupRx(HiSnrUsrp& sdr){sdr.setupRx();}
};
/**
